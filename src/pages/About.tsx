...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-foreground/20 pt-16">
      <SEOHead
        title={`Sobre — ${profile?.full_name || "Tarliso Dória"}`}
        description={profile?.bio_summary || "Conheça a trajetória e experiência de Tarliso Dória, Especialista em Dados, BI e Governança de Dados."}
        canonical="https://tarlisodoria.com/about"
        ogType="profile"
        jsonLd={{
          ...
          url: "https://tarlisodoria.com/about",
