...
const Blog = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-foreground/20 pt-16">
      <SEOHead
        title="Blog — Dados, BI e Governança de Dados"
        description="Artigos e insights sobre Dados, BI, Power BI e Governança de Dados por Tarliso Dória."
        canonical="https://tarlisodoria.com/blog"
        ogType="website"
        jsonLd={{
          "@context": "https://schema.org",
          "@type": "Blog",
          name: "Blog — Tarliso Dória",
          description: "Artigos e insights sobre Dados, BI, Power BI e Governança de Dados.",
          url: "https://tarlisodoria.com/blog",
          author: {
            "@type": "Person",
            name: "Tarliso Dória",
          },
          blogPost: contents.map((post) => ({
            ...
            url: `https://tarlisodoria.com/blog/${post.slug || post.id}`,
      ...
      <section className="pt-32 pb-16 px-8 sm:px-12 lg:px-20 max-w-[1400px] mx-auto animate-[fadeInUp_0.6s_ease-out_both]">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-light tracking-tight text-foreground leading-[1.05] max-w-4xl">
          Explorando a fronteira dos <span className="text-primary italic">Dados e BI</span>.
        </h1>
      </section>
