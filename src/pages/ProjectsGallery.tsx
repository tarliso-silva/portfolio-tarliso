  ...
  return (
    <div className="min-h-screen bg-background pt-16">
      <SEOHead
        ...
        description="Explore os projetos de dados, dashboards e soluções de BI desenvolvidos por Tarliso Dória."
        canonical="https://tarlisodoria.com/projects"
        ogType="website"
        jsonLd={{
          "@context": "https://schema.org",
          "@type": "CollectionPage",
          name: "Projetos — Tarliso Dória",
          description: "Portfólio de projetos em Dados, BI e Governança de Dados.",
          url: "https://tarlisodoria.com/projects",
        }}
      />
      <div className="container mx-auto px-4 py-8 md:py-16">
        ...
        <div className="animate-fade-up">
          ...
          <p className="text-muted-foreground mt-4 max-w-2xl text-lg">
            Explore os projetos de dados, dashboards de BI e soluções de Governança de Dados.
          </p>
        </div>
