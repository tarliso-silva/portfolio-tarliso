...
ADD COLUMN IF NOT EXISTS hero_phrase_start TEXT DEFAULT 'Dados são o',
ADD COLUMN IF NOT EXISTS hero_phrase_strike TEXT DEFAULT 'futuro',
ADD COLUMN IF NOT EXISTS hero_phrase_end TEXT DEFAULT 'presente.',
